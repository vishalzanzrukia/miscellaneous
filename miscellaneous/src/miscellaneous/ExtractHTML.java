...
public class ExtractHTML {
  ...
  public static void testSortMapMonthWiseByKey() {


    List<Map<SortPage, Object>> finalList = new ArrayList<Map<SortPage, Object>>();

    Map<SortPage, Object> map = new HashMap<SortPage, Object>();
    map.put(new SortPage("august"), "hello1");
    finalList.add(0, map);

    map = new HashMap<SortPage, Object>();
    map.put(new SortPage("january"), "hello2");
    finalList.add(1, map);

    map = new HashMap<SortPage, Object>();
    map.put(new SortPage("may"), "hello3");
    finalList.add(2, map);

    map = new HashMap<SortPage, Object>();
    map.put(new SortPage("december"), "hello4");
    finalList.add(3, map);

    map = new HashMap<SortPage, Object>();
    map.put(new SortPage("october"), "hello5");
    finalList.add(4, map);

    map = new HashMap<SortPage, Object>();
    map.put(new SortPage("september"), "hello6");
    finalList.add(5, map);

    map = new HashMap<SortPage, Object>();
    map.put(new SortPage("february"), "hello7");
    finalList.add(6, map);

    List<Map<SortPage, Object>> list = sortMapMonthWiseByKey(finalList, "month");
    for (Map<SortPage, Object> row : list) {
      SortPage sortPage = row.keySet().iterator().next();
      System.out.println(sortPage);
      System.out.println(row.get(sortPage));
    }


    // Map<SortPage,? super Object> returnMap = sortMapMonthWiseByKey(finalList, "month");
    /*
     * for(Entry<SortPage,? super Object> entry : returnMap.entrySet()) {
